    ...
    function htmlPathForParagraph(element, messages) {
        ...
        if (element.indent) {
            if (element.indent.firstLine !== null && element.indent.firstLine !== undefined) {
                style = style + "text-indent: " + element.indent.firstLine / 20 + ";";
            }
            if (element.indent.hanging !== null && element.indent.hanging !== undefined) {
                style = style + "padding-left: " + element.indent.hanging / 20 + ";";
                style = style + "text-indent: -" + element.indent.hanging / 20 + ";";
            }
            if (element.indent.before !== null && element.indent.before !== undefined) {
                style = style + "margin-left: " + element.indent.before / 20 + ";";
            }
            if (element.indent.after !== null && element.indent.after !== undefined) {
                style = style + "margin-right: " + element.indent.after / 20 + ";";
            }
        }
        if (element.spacing) {
            if (element.spacing.line !== null && element.spacing.line !== undefined) {
                if (element.spacing.lineRule !== null && (element.spacing.lineRule === "atLeast" || element.spacing.lineRule === "exactly")) {
                    style = style + "line-height: " + (element.spacing.line / 20) + "px;"
                }
                else {
                    style = style + "line-height: " + (element.spacing.line / 240) + ";"
                }

            }

            if (element.spacing.before !== null && element.spacing.before !== undefined) {
                style = style + "margin-top: " + element.spacing.before / 20 + ";"
            }
            if (element.spacing.after !== null && element.spacing.after !== undefined) {
                style = style + "margin-bottom: " + element.spacing.after / 20 + ";"
            }
        }
        if (style && style !== "") {
            ...
            returnHtmlPath = htmlPaths.topLevelElement("p", attributes);
        }
