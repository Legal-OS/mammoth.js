...
var extension = require("./body-reader-extension");
...
function BodyReader(options) {
        ...
        "w:pPr": function(element) {
            return readParagraphStyle(element).map(function(style) {
                return {
                    ...
                    spacing: extension.readParagraphSpacing(element.firstOrEmpty("w:spacing"))
                };
            });
        },
    ...
    function readTableProperties(element) {
        ...
        if (widthAttributes.value && widthAttributes.value.length) {
    ...
    function readTableCell(element) {
        return readXmlElements(element.children).map(function(children) {
            ...
            var cell = extension.TableCellWithProperties(properties, children, colSpan);
