...
function withTableWidth(element, defaultTablePath) {
    var deafultTablePathAttributes = defaultTablePath._elements && defaultTablePath._elements[0] && defaultTablePath._elements[0].attributes;
    if (element.width && deafultTablePathAttributes) {
        if (element.widthUnit === "dxa") {
            var widthInPts = parseInt(element.width, 10) / 20;
            deafultTablePathAttributes.style += "width: " + widthInPts + "pt;";
        } else if (element.widthUnit === "pct") {
            var widthInPercent = parseInt(element.width, 10) / 50;
            deafultTablePathAttributes.style += "width: " + widthInPercent + "%;";
        }
    }
