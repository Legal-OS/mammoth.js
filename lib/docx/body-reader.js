...
function BodyReader(options) {
    ...
    var xmlElementReaders = {
        ...
        "w:tbl": extension.createReadTable(ReadResult, emptyResult, readTableStyle, combineResults, readXmlElements, calculateRowSpans),
        "w:tr": readTableRow,
        "w:tc": readTableCell,
    ...
    function readTable(element) { // eslint-disable-line
