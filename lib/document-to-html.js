...
function DocumentConversion(options, comments) {
    ...
    function convertRun(run, messages, options) {
        ...
        if (run.shading || run.highlight) {
            paths.push(htmlPaths.element('mark', { style: "background-color:" + run.shading || run.highlight }, { fresh: false }));
        }
        if (run.font) {
            paths.push(htmlPaths.element('mark', { style: "font-family:" + run.font }, { fresh: false }));
        }
        if (run.fontSize) {
            paths.push(htmlPaths.element('mark', { style: "font-size:" + run.fontSize }, { fresh: false }));
        }
